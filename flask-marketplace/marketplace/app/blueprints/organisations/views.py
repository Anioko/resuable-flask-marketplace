...
def org_home():
    ...
    return render_template('organisations/org_dashboard.html', website_settings=website_settings, orgs=orgs)
...
def select_org(org_id):
    ...
    if current_user.id != org.user_id and current_user not in org.get_staff():
        abort(404)
    return render_template('organisations/org_operations.html', website_settings=website_settings, op='home', org=org)
...
def create_org():
    ...
    return render_template('organisations/create_org.html', website_settings=website_settings, form=form)
...
def edit_org(org_id):
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            flash('Error! Data was not added.', 'error')
    return render_template('organisations/edit_org.html', website_settings=website_settings, form=form, org=org)
...
def list_positions(org_id):
    ...
    return render_template('organisations/list_positions.html', website_settings=website_settings, positions=positions, org=org)
...
def list_promos(org_id):
    ...
    return render_template('organisations/list_promos.html', website_settings=website_settings, promos=promos, org=org)
...
def list_staff(org_id):
    ...
    if current_user.id != org.user_id and current_user not in org.get_staff():
        abort(404)
    staff = org.get_staff()
    return render_template('organisations/list_staff.html', website_settings=website_settings, staff=staff, org=org)
...
def create_position(org_id):
    ...
    return render_template('organisations/create_job.html', website_settings=website_settings, form=form, org=org)
...
def create_promo(org_id):
    ...
    return render_template('organisations/create_promo.html', website_settings=website_settings, form=form, org=org)
...
def org_view(org_id):
    ...
    if org_detail is not None:
        return render_template('organisations/org_view.html', website_settings=website_settings, org_detail=org_detail, org=org_detail)
...
def view_applicants(id):
    ...
    if position is None:
        ...
        return render_template('organisations/applicants.html', id=id, website_settings=website_settings,
...
def view_submissions(id):
    ...
    if promo is None:
        ...
        # print(applicants_profiles[2])
        return render_template('organisations/submissions.html', id=id, website_settings=website_settings,
...
def position_applicants_send_email(id):
    ...
    if current_user.id is None:
        ...
        return render_template('organisations/message_send_form.html', website_settings=website_settings, form=form)
...
def logo_upload():
    ...
    return render_template('organisations/upload.html', website_settings=website_settings, form=form)
...
def invite_user(org_id):
    ...
    if form.validate_on_submit():
        ...
        flash('User {} successfully invited'.format(user.full_name),
              'form-success')
        return redirect(url_for('organisations.org_home'))
    return render_template('organisations/new_user.html', website_settings=website_settings, form=form, org=org)
