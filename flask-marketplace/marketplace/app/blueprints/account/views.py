...
from app.models import Photo, MSettings
import datetime
...
def login():
    ...
    return render_template('account/login.html', website_settings=website_settings, form=form, next=next)
...
def register():
    ...
    if request.method == 'GET':
        ...
        return render_template('account/register.html', website_settings=website_settings, form=form)
...
def manage():
    website_settings = MSettings.query.first()
    return render_template('account/manage.html', website_settings=website_settings, user=current_user, form=None)
...
def profile(active, page):
    website_settings = MSettings.query.first()
    return render_template('main/profile.html', website_settings=website_settings, user=current_user, current_user=current_user,
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('account.login'))
    return render_template('account/reset_password.html', website_settings=website_settings, form=form)
...
def change_password():
    ...
    return render_template('account/manage.html', website_settings=website_settings, form=form)
...
def join_from_invite(user_id, token):
    ...
    if new_user.confirm_account(token):
        ...
        if form.validate_on_submit():
            ...
            return redirect(url_for('account.login'))
        return render_template('account/join_invite.html', website_settings=website_settings, form=form)
    else:
...
def unconfirmed():
    ...
    if current_user.is_anonymous or current_user.confirmed:
        return redirect(url_for('main.index'))
    return render_template('account/unconfirmed.html', website_settings=website_settings)
